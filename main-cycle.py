...
deepseek_id = 128001
model_id = qwen_id
max_new_tokens = 300 # 最大输出长度
max_history_length = 10


def chat():
    print("Dialog starts! input 'exit' to end dialog")
    print("Add '[debug]'at the end of input so that you can see the full response of AI")
    print("Inputting 'history' can show last max_history_length of dialog history")
    history = []
    full_response = False
